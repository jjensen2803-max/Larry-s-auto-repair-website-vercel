    ...
    >
      <defs>
        <linearGradient id={`chrome-${id}`} x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="16%" stopColor="#b4bac1" />
          <stop offset="33%" stopColor="#ffffff" />
          <stop offset="50%" stopColor="#8e959c" />
          <stop offset="51%" stopColor="#6b727a" />
          <stop offset="68%" stopColor="#c9ced4" />
          <stop offset="86%" stopColor="#f6f8f9" />
...
function LeadForm() {
  ...
  return (
    <form className="quote-card" onSubmit={submit}>
      ...
      <label>
        <span>Phone</span>
        <input name="phone" type="tel" autoComplete="tel" placeholder="(208) 555-0123" required minLength={7} />
      </label>
      <label>
